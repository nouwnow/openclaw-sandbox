...
I want to build an Obsidian memory system into OpenClaw. Here's how it will work:
...
Things like "Muddy's name", "SSH into DGX with ssh spark", "vault is at X path"
...
--------------------------------------
Location: /home/michiel/wiki-vault Obsidian vault, shared with OpenClaw
